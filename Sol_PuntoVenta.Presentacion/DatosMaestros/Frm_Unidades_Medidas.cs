...
namespace Sol_PuntoVenta.Presentacion
{
    public partial class Frm_Unidades_Medidas : Form
    {
        ...
        private void Selecciona_dgv()
        {
            ...
            {
                Codigo_um = Convert.ToInt32(Dgv_Listado.CurrentRow.Cells["codigo_um"].Value);
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (Txt_abreviatura_um.Text==string.Empty ||
                ...
                {
                    E_Unidades_Medidas oPro = new E_Unidades_Medidas();
                    string Cduplica, Rpta = "";
                    oPro.Codigo_um = Codigo_um;
                    oPro.Abreviatura_um = Txt_abreviatura_um.Text.Trim();
                    oPro.Descripcion_um = Txt_descripcion_um.Text.Trim();
                    
                    // Verificamos si la información que se intenta guardar ya existe en la tabla
                    Cduplica = N_Unidades_Medidas.Verifica_duplicado_um(this.EstadoGuarda, oPro.Codigo_um, oPro.Descripcion_um);
                    if (Cduplica == "")
                    {
                        Rpta = N_Unidades_Medidas.Guardar_um(this.EstadoGuarda, oPro);
                        if (Rpta.Equals("OK"))
                        {
        ...
        private void Btn_reporte_Click(object sender, EventArgs e)
        {
            ...
            ORpt_um.Txt_p1.Text = Txt_buscar.Text;
            ORpt_um.ShowDialog();
        }
    }
}
