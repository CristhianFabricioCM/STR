...
using Sol_PuntoVenta.Presentacion.DatosMaestros;
...
namespace Sol_PuntoVenta.Presentacion
{
    public partial class Frm_MiDashBoard : Form
    {
        ...
        private void CO_departamentos_Click(object sender, EventArgs e)
        {
            openChildForm(new Frm_Departamentos());
            //hideSubMenu();
        }

        private void CO_provincias_Click(object sender, EventArgs e)
        {
            openChildForm(new Frm_Provincias());
            //hideSubMenu();
        }

        private void CO_distritos_Click(object sender, EventArgs e)
        {
            openChildForm(new Frm_Distritos());
            //hideSubMenu();
        }

        private void DM_clientes_Click(object sender, EventArgs e)
        {
        ...
        private void CO_empresa_Click(object sender, EventArgs e)
        {
            openChildForm(new Frm_Empresa());
            //hideSubMenu();
        }
    }
}
